            ...
            <div class="lg:flex lg:justify-between">
                <div class="mb-6 lg:mb-0">
                    <a class="flex gap-2 items-center">
                        <img src="../assets/images/logo-stellae.png" class="h-10 w-14" alt="">
                        <span class="self-center text-2xl font-extralight whitespace-nowrap">STELLAE</span>
                    </a>
                </div>
            </div>
            <hr class="my-6 border-white sm:mx-auto lg:my-8" />
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-white sm:text-center">© 2024 <a class="hover:underline">Stellae Gaming™</a>. All
                    Rights Reserved.
                </span>
                <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                    <a href="https://instagram.com/stellaegaming/" target="_blank"
                        class="text-white hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" fill="white" width="20" height="20"
                            viewBox="0 0 50 50">
                            <path
                    ...
                    <a href="mailto:@gmail.com" target="_blank" class="text-white hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="white" width="20px" height="20px">
                            <path
